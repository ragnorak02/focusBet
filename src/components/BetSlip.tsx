        ...
        {slip.map((s) => (
          <div key={s.fightId} className="slip-in p-3">
            <div className="flex items-start justify-between gap-2">
              ...
              {/* Wide gap so the price isn't crowded against the remove tap
                  target — they sit a thumb-width apart. */}
              <div className="flex shrink-0 items-center gap-4">
                ...
                <button
                  ...
                  className="rounded p-1 text-loss-500 hover:bg-loss-500/15 active:bg-loss-500/25"
        ...
        {effectiveMode === 'parlay' ? (
          <>
            ...
            <div className="mt-2 flex gap-1.5">
              {QUICK.map((q) => (
                <button
                  key={q}
                  onClick={() => setParlayStake(String(round2(parlayStakeNum + q)))}
            ...
            <div className="mt-3 flex items-center justify-between rounded-lg bg-ink-900 px-3 py-2">
              <span className="text-xs font-semibold text-ink-400">Total payout</span>
          ...
          <>
            <div className="mb-2 flex items-center justify-between rounded-lg bg-ink-900 px-3 py-2">
              <span className="text-xs font-semibold text-ink-400">Total stake</span>
